...
public class WebController {
    ...
    public ResponseEntity<?> submitVocabTestResult(@RequestParam(name = "id") Long topicId,
       ...
       // log.info(LogMarkerUtil.TEST_MARKER,"userId: {}; topicId: {}, complete test",userDetails.getUser().getId(),topicId);
        LogMarkerUtil.loggerTest.info("userId: {}; topicId: {}, complete test",userDetails.getUser().getId(),topicId);
        return new ResponseEntity<>(HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> createComment(@RequestParam(name = "id") Long topicId,
       ...
       // log.info(LogMarkerUtil.COMMENT_MARKER, "Comment: {}; userId: {}; topicId: {}", request.getMessage(), userDetails.getUser().getId(), topicId);
       LogMarkerUtil.loggerComment.info("Comment: {}; userId: {}; topicId: {}", request.getMessage(), userDetails.getUser().getId(), topicId);
