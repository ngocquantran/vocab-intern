...
public class AuthApi {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest request, HttpSession session) {
        try {
            ...
            String id = ((UserDetailsCustom) SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getUser().getId();

            // log.info(LogMarkerUtil.LOGIN_MARKER,"Login - UserId = {}",id);
            LogMarkerUtil.loggerLogin.info( "Login - UserId = {}", id);
