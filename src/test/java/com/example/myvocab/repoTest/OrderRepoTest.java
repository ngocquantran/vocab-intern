...
public class OrderRepoTest {
    ...
    void find_order_byStatus_and_keyword() {
        ...
        Page<OrderInfoTable> page1 = ordersRepo.findByStatusOrderByOrderDateDesc(OrderStatus.PENDING, pageable);
        assertThat(page1.getContent()).hasSize(1);

        Page<OrderInfoTable> page2 = ordersRepo.findByStatusOrderByOrderDateDesc(OrderStatus.ACTIVATED, pageable);
        assertThat(page2.getContent()).hasSize(0);

        Page<OrderInfoTable> page3 = ordersRepo.findByStatusAndKeyWord(OrderStatus.ACTIVATED, "3 tháng", pageable);
        assertThat(page3.getContent()).hasSize(0);

        Page<OrderInfoTable> page4 = ordersRepo.findByStatusAndKeyWord(OrderStatus.PENDING, "3 tháng", pageable);
        assertThat(page4.getContent()).hasSize(1);

        Page<OrderInfoTable> page5 = ordersRepo.findByStatusAndKeyWord(OrderStatus.PENDING, "Trần Văn A", pageable);
        assertThat(page5.getContent()).hasSize(1);

        Page<OrderInfoTable> page6 = ordersRepo.findByStatusAndKeyWord(OrderStatus.PENDING, "b@gmail.com", pageable);
